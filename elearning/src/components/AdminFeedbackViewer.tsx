...
const AdminFeedbackViewer: React.FC<AdminFeedbackViewerProps> = ({ courseId, weekId }) => {
    ...
    try {
      ...
      if (weekId) {
        ...
        const [weekFeedback, weekStats] = await Promise.all([
          weekFeedbackService.getWeekFeedback(weekId),
          weekFeedbackService.getWeekFeedbackStats(weekId)
        ]);
