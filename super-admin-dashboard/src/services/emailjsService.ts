...
export const sendPasswordResetEmail = async (
  ...
  try {
    ...
    const templateParams = {
      ...
      message: `Hi ${userName}!\n\nYou requested a password reset for your Excellence Coaching Hub Admin account. Click the link below to reset your password:\n\n${resetUrl}\n\nThis link will expire in one hour.\n\nIf you didn't request this, please ignore this email.\n\nBest regards,\nExcellence Coaching Hub Team`,
      subject: 'Password Reset - Excellence Coaching Hub Admin'
    };
...
export const sendWelcomeEmail = async (
  ...
  try {
    const templateParams = {
      ...
      message: `Welcome to Excellence Coaching Hub Admin Panel, ${userName}!\n\nYour admin account has been successfully created. You can now access your admin dashboard and manage the platform.\n\nDashboard: ${window.location.origin}/dashboard\n\nBest regards,\nExcellence Coaching Hub Team`,
      subject: 'Welcome to Excellence Coaching Hub Admin Panel!'
    };
    ...
    console.log('=================================');
    console.log(`To: ${userEmail}`);
    console.log(`Welcome to Excellence Coaching Hub Admin Panel, ${userName}!`);
    console.log('=================================');
    return false;
  }
};
...
export const testEmailJSConnection = async (testEmail: string): Promise<boolean> => {
  try {
    ...
    const testParams = {
      ...
      // Sender and content
      from_name: 'Excellence Coaching Hub Admin',
      message: 'This is a test email from Excellence Coaching Hub Admin Panel.',
      subject: 'Test Email'
    };
